<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta5'])) {
            $escolha = $_POST['pergunta5'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 05/10</h3></center>
            <p>Qual elemento da natureza combina mais com você?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta5" id="opcao1" value="corvinal"> Ar
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta5" id="opcao2" value="grifinoria"> Fogo
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta5" id="opcao3" value="sonserina"> Água
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta5" id="opcao4" value="lufa-lufa"> Terra
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta6.php";
                });
            });
            </script>';
        }
