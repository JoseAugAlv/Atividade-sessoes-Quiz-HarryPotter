<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta8'])) {
            $escolha = $_POST['pergunta8'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 08/10</h3></center>
            <p>Quando você se sente mais verdadeiramente você mesmo?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta8" id="opcao1" value="grifinoria"> Quando estou enfrentando um desafio e superando meus limites
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta8" id="opcao2" value="lufa-lufa"> Quando estou ajudando alguém sem esperar nada em troca
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta8" id="opcao3" value="corvinal"> Quando estou refletindo sozinho, buscando entender o mundo e a mim mesmo
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta8" id="opcao4" value="sonserina"> Quando estou traçando estratégias para alcançar algo importante para mim
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta9.php";
                });
            });
            </script>';
        }
