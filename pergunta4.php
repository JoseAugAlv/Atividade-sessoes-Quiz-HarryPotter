<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta4'])) {
            $escolha = $_POST['pergunta4'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 04/10</h3></center>
            <p>Se alguém te desafia na frente de todos, qual sua reação?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta4" id="opcao1" value="corvinal"> Para e pensa se vale a pena
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta4" id="opcao2" value="grifinoria"> Você aceita na mesma hora
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta4" id="opcao3" value="lufa-lufa"> Tenta resolver de forma pacífica
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta4" id="opcao4" value="sonserina"> Pensa numa estratégia para vencer
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta5.php";
                });
            });
            </script>';
        }
