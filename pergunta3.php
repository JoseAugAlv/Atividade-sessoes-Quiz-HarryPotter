<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta3'])) {
            $escolha = $_POST['pergunta3'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 03/10</h3></center>
            <p>Você encontra uma sala secreta em Hogwarts que ninguém conhece. O que você faz?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta3" id="opcao1" value="grifinoria"> Chama seus amigos para explorarem juntos
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta3" id="opcao2" value="sonserina"> Guarda segredo e pensa como pode usar aquela sala para benefício próprio
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta3" id="opcao3" value="corvinal"> Investiga sozinho para saber como a sala funciona
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta3" id="opcao4" value="lufa-lufa"> Conta para um professor ou para a direção
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta4.php";
                });
            });
            </script>';
        }
