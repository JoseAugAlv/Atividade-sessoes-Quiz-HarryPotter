<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta9'])) {
            $escolha = $_POST['pergunta9'];
...
<body>
    ...
    <div class="campo_pergunta">
       <div class="pergunta">
        <center><h3>Pergunta 09/10</h3></center>
            <p>Quando alguém com quem você se importa está passando por dificuldades, como você reage?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta9" id="opcao1" value="lufa-lufa"> Ofereço meu apoio incondicional e tento ajudar da forma mais prática possível
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta9" id="opcao2" value="grifinoria"> Encorajo essa pessoa a enfrentar os desafios de frente, com coragem e determinação
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta9" id="opcao3" value="corvinal"> Tento entender profundamente o problema para oferecer conselhos sábios e bem fundamentados
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta9" id="opcao4" value="sonserina"> Penso estrategicamente em como essa situação pode ser usada para crescer e se fortalecer
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta10.php";
                });
            });
            </script>';
        }
