<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta6'])) {
            $escolha = $_POST['pergunta6'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 06/10</h3></center>
            <p>Quem você é no seu grupo de amigos?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta6" id="opcao1" value="lufa-lufa"> O que está sempre disposto a ajudar
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta6" id="opcao2" value="grifinoria"> “Líder”
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta6" id="opcao3" value="corvinal"> Conselheiro(a)
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta6" id="opcao4" value="sonserina"> Protetor(a)
                </label>
        ...
        if ($mostrar_sweetAlert1) {
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    window.location.href = "pergunta7.php";
                });
            });
            </script>';
        }
