<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (!empty($_POST['pergunta10'])) {
            $escolha = $_POST['pergunta10'];
...
<body>
    ...
    <div class="campo_pergunta">
        <div class="pergunta">
            <center><h3>Pergunta 10/10</h3></center>
            <p>Se você tivesse que tomar uma decisão importante que pode afetar muitas pessoas, como você agiria?</p>
        </div>
        <div class="opcoes">
            <form action="" method="post">
                <label for="opcao1">
                    <input type="radio" name="pergunta10" id="opcao1" value="corvinal"> Analisaria todas as informações e consequências cuidadosamente antes de agir
                </label>
                <label for="opcao2">
                    <input type="radio" name="pergunta10" id="opcao2" value="grifinoria"> Agiria com coragem e rapidez, mesmo que haja riscos, para proteger o bem maior
                </label>
                <label for="opcao3">
                    <input type="radio" name="pergunta10" id="opcao3" value="sonserina"> Planejaria estrategicamente, buscando o maior benefício para mim e para os envolvidos
                </label>
                <label for="opcao4">
                    <input type="radio" name="pergunta10" id="opcao4" value="lufa-lufa"> Consideraria o impacto nas pessoas ao meu redor, priorizando o cuidado e o apoio mútuo
                </label>
